      ...
      <DialogContent className="max-w-lg bg-white max-h-[85vh] overflow-y-auto">
        ...
        {loading && (
          <div className="py-6 text-center space-y-3">
            <RefreshCw className="w-6 h-6 mx-auto text-violet-500 animate-spin" />
            <p className="text-xs text-slate-500">Browsing LinkedIn, company website and the web for verified data...</p>
            <div className="space-y-2 animate-pulse px-4">
