...
export default function LeadDetails({ 
  ...
  const handleAddActivity = async () => {
    ...
    await onActivityCreate({ lead_id: lead.id, ...activityForm });
  ...
  return (
    <>
      <Sheet open={open} onOpenChange={onClose}>
        <SheetContent className="w-full sm:max-w-2xl overflow-y-auto bg-white p-4 sm:p-6">
          ...
          <Tabs defaultValue="details" className="mt-6">
            ...
            <TabsContent value="details" className="space-y-6 mt-4">
              ...
              <Card className="p-4 space-y-3 bg-slate-50 border-0">
                ...
                {lead.industry && (
                  <div className="text-sm text-slate-600 pl-7">Industry: {lead.industry}</div>
                )}
                {lead.website && (
              ...
              <Card className="p-4 space-y-3 bg-slate-50 border-0">
                ...
                {lead.estimated_value && (
                  <div className="flex items-center gap-3 text-sm font-semibold text-emerald-600">
                    <DollarSign className="w-4 h-4" /> ${lead.estimated_value.toLocaleString()} estimated value
                  </div>
                )}
            ...
            <TabsContent value="activity" className="mt-4">
              {!isAddingActivity ? (
                <Button variant="outline" className="w-full mb-4" onClick={() => setIsAddingActivity(true)}>
                ...
                <Card className="p-4 mb-4 space-y-3 border-slate-200">
                  ...
                  <Textarea
                    ...
                    rows={2}
                  />
                  <Button className="w-full bg-slate-900 hover:bg-slate-800" onClick={handleAddActivity} disabled={!activityForm.title.trim()}>
                    Save Activity
                  </Button>
                </Card>
              )}
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center justify-between">
                              ...
                              {activity.completed && <CheckCircle2 className="w-4 h-4 text-emerald-500" />}
                            </div>
